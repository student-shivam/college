...
export default function AdminDashboardPage() {
  ...
  async function refresh() {
    ...
    try {
      ...
      const next = await backend.getAdminDashboardOverview({
        days: prefs.days,
        alertLimit: prefs.alertLimit,
        topLimit: prefs.topLimit
      });
      setData(next);
    } catch (err) {
  ...
  useEffect(() => {
    ...
    window.addEventListener(adminPrefEvents.dashboardChanged, onPrefsChanged);
    return () => window.removeEventListener(adminPrefEvents.dashboardChanged, onPrefsChanged);
  }, []);
  ...
  useEffect(() => {
    ...
    try {
      const prefs = loadAdminDashboardPrefs();
      es = backend.openAdminDashboardStream({
        days: prefs.days,
        alertLimit: prefs.alertLimit,
        topLimit: prefs.topLimit,
    ...
    return [
      {
        ...
        value: data?.cards?.totalMachines ?? DASH,
    ...
    <div className="page dashboard-page">
      <div className="page-head">
        <div>
          ...
          <h1>Dashboard</h1>
          <p className="muted">
            Live machine status and risk overview{" "}
        ...
        <div className="panel">
          ...
          <div className="dash-donut">
            <DonutChart
              ...
              centerValue={data?.cards?.totalMachines}
            />
        ...
        <div className="panel">
          <div className="panel-head">
            <div>
              ...
              <div className="panel-sub">Latest triggered events</div>
            </div>
        ...
        <div className="panel">
          <div className="panel-head">
            <div>
              ...
              <div className="panel-sub">Based on latest prediction per machine</div>
            </div>
          </div>
